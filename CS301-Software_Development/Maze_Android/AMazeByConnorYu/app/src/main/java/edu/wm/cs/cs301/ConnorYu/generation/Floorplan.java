...
public class Floorplan {
	...
	//Methods that Connor Yu Added
	public void checkBorders() {
		for (int i = 0; i < width; i++)
			for (int k = 0; k < height; k++) {
				if (isExitPosition(i,k) == true)
					System.out.println("Row: " + k + " Col: " + i + " is Exit");
				System.out.println("Checked: " + i + k);
			}
	}
	...
	/*
	 * for (int k = 0; k < height; k++) {
				if (hasBorder(i,k,-1,0) == true)
					System.out.println("Row: " + k + " Col: " + i + " Border to left");
				if (hasBorder(i,k,1,0) == true)
					System.out.println("Row: " + k + " Col: " + i + " Border to right");
				if (hasBorder(i,k,0,-1) == true)
					System.out.println("Row: " + k + " Col: " + i + " Border up");
				if (hasBorder(i,k,0,1) == true)
					System.out.println("Row: " + k + " Col: " + i + " Border down");
	 */
