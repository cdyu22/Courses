package edu.wm.cs.cs301.ConnorYu.generation;
...
import edu.wm.cs.cs301.ConnorYu.gui.MazeFileWriter;

import static edu.wm.cs.cs301.ConnorYu.gui.MazePanel.getColorEncoding;
...
public class Wall {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        case 0:
            ...
            break;
        case 1:
            setColor(getColorEncoding(RGB_DEF, RGB_DEF_GREEN, RGB_DEF));
            break;
        case 2:
            setColor(getColorEncoding(RGB_DEF, RGB_DEF, rgbValue));
            break;
        case 3:
            setColor(getColorEncoding(rgbValue, RGB_DEF_GREEN, RGB_DEF));
            break;
        case 4:
            setColor(getColorEncoding(RGB_DEF, RGB_DEF_GREEN, rgbValue));
            break;
        case 5:
            setColor(getColorEncoding(rgbValue, RGB_DEF, rgbValue));
            break;
        default:
            setColor(getColorEncoding(RGB_DEF, RGB_DEF, RGB_DEF));
            break;
        }
    }
    ...
    public boolean equals(final Object other) {
        ...
        if ((x != o.x) || (dx != o.dx) || (y != o.y) || (dy != o.dy)) {
            return false;
        }//TODO: PLEASE FOR THE LoVE OF GOD MAKE SURE THIS IS RIGHT
