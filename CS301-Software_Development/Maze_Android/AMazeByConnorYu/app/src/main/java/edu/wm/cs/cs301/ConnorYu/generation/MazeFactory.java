...
public class MazeFactory implements Factory {
	 ...
	 */
	public MazeFactory(boolean deterministic,int seed){
	...
	public boolean order(Order order) {
		...
		case DFS :
			builder = deterministic? new MazeBuilder(true,buildSeed) : new MazeBuilder();
			buildOrder();
			break;
		case Prim:
			builder = deterministic? new MazeBuilderPrim(true,buildSeed) : new MazeBuilderPrim();
			buildOrder();
			break;
		case Kruskal:
			builder = deterministic? new MazeBuilderKruskal(true,buildSeed) : new MazeBuilderKruskal();
			buildOrder();
			break;
		default:
